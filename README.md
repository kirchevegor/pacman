# pacman Для начала устанавливаем мультимедийную библиотеку SFML для 64-bit системы., а также компилятор mingw64. В изменении системных переменных устанавливаем его и проверяем в командной строке с помощью команды g++ --version версию, если 13.1.0, то установили правильно.
Ниже представлен код main.cpp.
